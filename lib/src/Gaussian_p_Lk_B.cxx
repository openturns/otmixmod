...
CLASSNAMEINIT(Gaussian_p_Lk_B)

/* Default constructor */
Gaussian_p_Lk_B::Gaussian_p_Lk_B()
...
/* Virtual constructor */
Gaussian_p_Lk_B * Gaussian_p_Lk_B::clone() const
{
  return new Gaussian_p_Lk_B(*this);
}

/* Mixmod name accessor */
OT::String Gaussian_p_Lk_B::convertToMixmod() const
{
  return "Gaussian_p_Lk_B";
}
