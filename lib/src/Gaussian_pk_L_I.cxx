...
namespace OTMIXMOD
{
  ...
  /* Virtual constructor */
  Gaussian_pk_L_I * Gaussian_pk_L_I::clone() const
  {
    return new Gaussian_pk_L_I(*this);
  }

  /* Mixmod name accessor */
  OT::String Gaussian_pk_L_I::convertToMixmod() const
  {
    return "Gaussian_pk_L_I";
  }
