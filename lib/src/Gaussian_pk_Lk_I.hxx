 ...
 *
 */
#ifndef OTMIXMOD_GAUSSIAN_PK_LK_I_HXX
#define OTMIXMOD_GAUSSIAN_PK_LK_I_HXX
...
namespace OTMIXMOD
{
  ...
  /**
   * @class Gaussian_pk_Lk_I
   *
   * @brief The class implements the gaussian_pk_Lk_I covariance model
   *
  ...
  public:
    ...
    /** Default constructor */
    explicit Gaussian_pk_Lk_I();

    /* Here is the interface that all derived class must implement */

    /* Virtual constructor */
    virtual Gaussian_pk_Lk_I * clone() const;
...
#endif /* OTMIXMOD_GAUSSIAN_PK_LK_I_HXX */
