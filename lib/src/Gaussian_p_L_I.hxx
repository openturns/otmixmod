 ...
 *
 */
#ifndef OTMIXMOD_GAUSSIAN_P_L_I_HXX
#define OTMIXMOD_GAUSSIAN_P_L_I_HXX
...
namespace OTMIXMOD
{
  ...
  /**
   * @class Gaussian_p_L_I
   *
   * @brief The class implements the gaussian_p_L_I covariance model
   *
  ...
  public:
    ...
    /** Default constructor */
    explicit Gaussian_p_L_I();

    /* Here is the interface that all derived class must implement */

    /* Virtual constructor */
    virtual Gaussian_p_L_I * clone() const;
...
#endif /* OTMIXMOD_GAUSSIAN_P_L_I_HXX */
