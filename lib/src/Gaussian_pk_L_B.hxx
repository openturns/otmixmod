 ...
 *
 */
#ifndef OTMIXMOD_GAUSSIAN_PK_L_B_HXX
#define OTMIXMOD_GAUSSIAN_PK_L_B_HXX
...
namespace OTMIXMOD
{
  ...
  /**
   * @class Gaussian_pk_L_B
   *
   * @brief The class implements the gaussian_pk_L_B covariance model
   *
  ...
  public:
    ...
    /** Default constructor */
    explicit Gaussian_pk_L_B();

    /* Here is the interface that all derived class must implement */

    /* Virtual constructor */
    virtual Gaussian_pk_L_B * clone() const;
...
#endif /* OTMIXMOD_GAUSSIAN_PK_L_B_HXX */
