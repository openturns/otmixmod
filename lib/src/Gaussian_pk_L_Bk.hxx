//                                               -*- C++ -*-
/**
 *  @file  Gaussian_pk_L_Bk.hxx
 *  @brief Implementation of the gaussian_pk_L_Bk covariance model
 *
 ...
 *
 */
#ifndef OTMIXMOD_GAUSSIAN_PK_L_BK_HXX
#define OTMIXMOD_GAUSSIAN_PK_L_BK_HXX
...
namespace OTMIXMOD
{
  ...
  /**
   * @class Gaussian_pk_L_Bk
   *
   * @brief The class implements the gaussian_pk_L_Bk covariance model
   *
  ...
  public:
    ...
    /** Default constructor */
    explicit Gaussian_pk_L_Bk();

    /* Here is the interface that all derived class must implement */

    /* Virtual constructor */
    virtual Gaussian_pk_L_Bk * clone() const;
...
#endif /* OTMIXMOD_GAUSSIAN_PK_L_BK_HXX */
