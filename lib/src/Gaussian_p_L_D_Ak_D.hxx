//                                               -*- C++ -*-
/**
 *  @file  Gaussian_p_L_D_Ak_D.hxx
 *  @brief Implementation of the gaussian_p_L_D_Ak_D covariance model
 *
 ...
 *
 */
#ifndef OTMIXMOD_GAUSSIAN_P_L_D_AK_D_HXX
#define OTMIXMOD_GAUSSIAN_P_L_D_AK_D_HXX
...
namespace OTMIXMOD
{
  ...
  /**
   * @class Gaussian_p_L_D_Ak_D
   *
   * @brief The class implements the gaussian_p_L_D_Ak_D covariance model
   *
  ...
  public:
    ...
    /** Default constructor */
    explicit Gaussian_p_L_D_Ak_D();

    /* Here is the interface that all derived class must implement */

    /* Virtual constructor */
    virtual Gaussian_p_L_D_Ak_D * clone() const;
...
#endif /* OTMIXMOD_GAUSSIAN_P_L_D_AK_D_HXX */
