 ...
 *
 */
#ifndef OTMIXMOD_GAUSSIAN_P_LK_CK_HXX
#define OTMIXMOD_GAUSSIAN_P_LK_CK_HXX
...
namespace OTMIXMOD
{
  ...
  /**
   * @class Gaussian_p_Lk_Ck
   *
   * @brief The class implements the gaussian_p_Lk_Ck covariance model
   *
  ...
  public:
    ...
    /** Default constructor */
    explicit Gaussian_p_Lk_Ck();

    /* Here is the interface that all derived class must implement */

    /* Virtual constructor */
    virtual Gaussian_p_Lk_Ck * clone() const;
...
#endif /* OTMIXMOD_GAUSSIAN_P_LK_CK_HXX */
