//                                               -*- C++ -*-
/**
 *  @file  Gaussian_pk_L_Ck.hxx
 *  @brief Implementation of the gaussian_pk_L_Ck covariance model
 *
 ...
 *
 */
#ifndef OTMIXMOD_GAUSSIAN_PK_L_CK_HXX
#define OTMIXMOD_GAUSSIAN_PK_L_CK_HXX
...
namespace OTMIXMOD
{
  ...
  /**
   * @class Gaussian_pk_L_Ck
   *
   * @brief The class implements the gaussian_pk_L_Ck covariance model
   *
  ...
  public:
    ...
    /** Default constructor */
    explicit Gaussian_pk_L_Ck();

    /* Here is the interface that all derived class must implement */

    /* Virtual constructor */
    virtual Gaussian_pk_L_Ck * clone() const;
...
#endif /* OTMIXMOD_GAUSSIAN_PK_L_CK_HXX */
