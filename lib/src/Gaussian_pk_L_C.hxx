//                                               -*- C++ -*-
/**
 *  @file  Gaussian_pk_L_C.hxx
 *  @brief Implementation of the gaussian_pk_L_C covariance model
 *
 ...
 *
 */
#ifndef OTMIXMOD_GAUSSIAN_PK_L_C_HXX
#define OTMIXMOD_GAUSSIAN_PK_L_C_HXX
...
namespace OTMIXMOD
{
  ...
  /**
   * @class Gaussian_pk_L_C
   *
   * @brief The class implements the gaussian_pk_L_C covariance model
   *
  ...
  public:
    ...
    /** Default constructor */
    explicit Gaussian_pk_L_C();

    /* Here is the interface that all derived class must implement */

    /* Virtual constructor */
    virtual Gaussian_pk_L_C * clone() const;
...
#endif /* OTMIXMOD_GAUSSIAN_PK_L_C_HXX */
