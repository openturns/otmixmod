//                                               -*- C++ -*-
/**
 *  @file  Gaussian_pk_L_Dk_A_Dk.hxx
 *  @brief Implementation of the gaussian_pk_L_Dk_A_Dk covariance model
 *
 ...
 *
 */
#ifndef OTMIXMOD_GAUSSIAN_PK_L_DK_A_DK_HXX
#define OTMIXMOD_GAUSSIAN_PK_L_DK_A_DK_HXX
...
namespace OTMIXMOD
{
  ...
  /**
   * @class Gaussian_pk_L_Dk_A_Dk
   *
   * @brief The class implements the gaussian_pk_L_Dk_A_Dk covariance model
   *
  ...
  public:
    ...
    /** Default constructor */
    explicit Gaussian_pk_L_Dk_A_Dk();

    /* Here is the interface that all derived class must implement */

    /* Virtual constructor */
    virtual Gaussian_pk_L_Dk_A_Dk * clone() const;
...
#endif /* OTMIXMOD_GAUSSIAN_PK_L_DK_A_DK_HXX */
