 ...
 *
 */
#ifndef OTMIXMOD_GAUSSIAN_P_LK_C_HXX
#define OTMIXMOD_GAUSSIAN_P_LK_C_HXX
...
namespace OTMIXMOD
{
  ...
  /**
   * @class Gaussian_p_Lk_C
   *
   * @brief The class implements the gaussian_p_Lk_C covariance model
   *
  ...
  public:
    ...
    /** Default constructor */
    explicit Gaussian_p_Lk_C();

    /* Here is the interface that all derived class must implement */

    /* Virtual constructor */
    virtual Gaussian_p_Lk_C * clone() const;
...
#endif /* OTMIXMOD_GAUSSIAN_P_LK_C_HXX */
