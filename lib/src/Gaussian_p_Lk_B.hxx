 ...
 *
 */
#ifndef OTMIXMOD_GAUSSIAN_P_LK_B_HXX
#define OTMIXMOD_GAUSSIAN_P_LK_B_HXX
...
namespace OTMIXMOD
{
  ...
  /**
   * @class Gaussian_p_Lk_B
   *
   * @brief The class implements the gaussian_p_Lk_B covariance model
   *
  ...
  public:
    ...
    /** Default constructor */
    explicit Gaussian_p_Lk_B();

    /* Here is the interface that all derived class must implement */

    /* Virtual constructor */
    virtual Gaussian_p_Lk_B * clone() const;
...
#endif /* OTMIXMOD_GAUSSIAN_P_LK_B_HXX */
