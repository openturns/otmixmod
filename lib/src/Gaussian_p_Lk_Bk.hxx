 ...
 *
 */
#ifndef OTMIXMOD_GAUSSIAN_P_LK_BK_HXX
#define OTMIXMOD_GAUSSIAN_P_LK_BK_HXX
...
namespace OTMIXMOD
{
  ...
  /**
   * @class Gaussian_p_Lk_Bk
   *
   * @brief The class implements the gaussian_p_Lk_Bk covariance model
   *
  ...
  public:
    ...
    /** Default constructor */
    explicit Gaussian_p_Lk_Bk();

    /* Here is the interface that all derived class must implement */

    /* Virtual constructor */
    virtual Gaussian_p_Lk_Bk * clone() const;
...
#endif /* OTMIXMOD_GAUSSIAN_P_LK_BK_HXX */
