 ...
 *
 */
#ifndef OTMIXMOD_GAUSSIAN_P_L_C_HXX
#define OTMIXMOD_GAUSSIAN_P_L_C_HXX
...
namespace OTMIXMOD
{
  ...
  /**
   * @class Gaussian_p_L_C
   *
   * @brief The class implements the gaussian_p_L_C covariance model
   *
  ...
  public:
    ...
    /** Default constructor */
    explicit Gaussian_p_L_C();

    /* Here is the interface that all derived class must implement */

    /* Virtual constructor */
    virtual Gaussian_p_L_C * clone() const;
...
#endif /* OTMIXMOD_GAUSSIAN_P_L_C_HXX */
