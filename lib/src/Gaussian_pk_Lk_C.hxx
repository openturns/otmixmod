//                                               -*- C++ -*-
/**
 *  @file  Gaussian_pk_Lk_C.hxx
 *  @brief Implementation of the gaussian_pk_Lk_C covariance model
 *
 ...
 *
 */
#ifndef OTMIXMOD_GAUSSIAN_PK_LK_C_HXX
#define OTMIXMOD_GAUSSIAN_PK_LK_C_HXX
...
namespace OTMIXMOD
{
  ...
  /**
   * @class Gaussian_pk_Lk_C
   *
   * @brief The class implements the gaussian_pk_Lk_C covariance model
   *
  ...
  public:
    ...
    /** Default constructor */
    explicit Gaussian_pk_Lk_C();

    /* Here is the interface that all derived class must implement */

    /* Virtual constructor */
    virtual Gaussian_pk_Lk_C * clone() const;
...
#endif /* OTMIXMOD_GAUSSIAN_PK_LK_C_HXX */
