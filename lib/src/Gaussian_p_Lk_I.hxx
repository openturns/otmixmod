//                                               -*- C++ -*-
/**
 *  @file  Gaussian_p_Lk_I.hxx
 *  @brief Implementation of the gaussian_p_Lk_I covariance model
 *
 ...
 *
 */
#ifndef OTMIXMOD_GAUSSIAN_P_LK_I_HXX
#define OTMIXMOD_GAUSSIAN_P_LK_I_HXX
...
namespace OTMIXMOD
{
  ...
  /**
   * @class Gaussian_p_Lk_I
   *
   * @brief The class implements the gaussian_p_Lk_I covariance model
   *
  ...
  public:
    ...
    /** Default constructor */
    explicit Gaussian_p_Lk_I();

    /* Here is the interface that all derived class must implement */

    /* Virtual constructor */
    virtual Gaussian_p_Lk_I * clone() const;
...
#endif /* OTMIXMOD_GAUSSIAN_P_LK_I_HXX */
