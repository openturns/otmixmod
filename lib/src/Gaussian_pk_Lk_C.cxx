...
namespace OTMIXMOD
{
  ...
  CLASSNAMEINIT(Gaussian_pk_Lk_C);
  ...
  /* Virtual constructor */
  Gaussian_pk_Lk_C * Gaussian_pk_Lk_C::clone() const
  {
    return new Gaussian_pk_Lk_C(*this);
  }

  /* Mixmod name accessor */
  OT::String Gaussian_pk_Lk_C::convertToMixmod() const
  {
